    ...
    <StyledWrapper>
      <div className="card">
        ...
        <div className="card-title-area">
          ...
          <span className="card-tag">Rating <span className='text-amber-600'>{rating}</span></span>
        </div>
        <div className="card-body">
          ...
          <p className='badge badge-warning mt-3'>{category}</p>
          <div className="card-actions">
            <div className="price">
              <span className="price-currency">$</span>${ratePerHour}
...
const StyledWrapper = styled.div`
  .card {
    --primary: oklch(75.9% 0.169 91.605);
